...
```
├── Basavaraj_StudentPerformanceAnalytics.ipynb   # Main analysis notebook
...
4. Launch the notebook:
   ```bash
   jupyter notebook Basavaraj_StudentPerformanceAnalytics.ipynb
   ```
...
Basavaraj — BCA student, IBM SkillsBuild Data Analytics with AI Academic
